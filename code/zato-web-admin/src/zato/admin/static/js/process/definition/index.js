...
$(document).ready(function() {
    ...
    $.fn.zato.data_table.new_row_func = $.fn.zato.process.definition.data_table.new_row;
    $.fn.zato.data_table.parse();
    $.fn.zato.data_table.setup_forms(['name', 'host', 'port', 'timeout', 'mode', 'get_criteria']);
})


$.fn.zato.process.definition.create = function() {
    $.fn.zato.data_table._create_edit('create', 'Create a new process definition', null);
}

$.fn.zato.process.definition.edit = function(id) {
    $.fn.zato.data_table._create_edit('edit', 'Update the process definition', id);
}

$.fn.zato.process.definition.data_table.new_row = function(item, data, include_tr) {
    var row = '';
    ...
    row += String.format('<td>{0}</td>', String.format("<a href=\"javascript:$.fn.zato.process.definition.edit('{0}')\">Edit</a>", item.id));
    row += String.format('<td>{0}</td>', String.format("<a href='javascript:$.fn.zato.process.definition.delete_({0});'>Delete</a>", item.id));
...
$.fn.zato.process.definition.delete_ = function(id) {
