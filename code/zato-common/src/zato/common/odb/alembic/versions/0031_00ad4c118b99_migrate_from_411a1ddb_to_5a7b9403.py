...
def upgrade():
    ...
    with op.batch_alter_table('pubsub_topic', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_endpoint', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_sub', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_message', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('web_socket_cli_ps_keys', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_endp_topic', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_endp_msg_queue', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('pubsub_endp_msg_q_inter', schema=None, naming_convention=alembic_utils.naming_convention) as batch_op:
    ...
    with op.batch_alter_table('web_socket_sub', schema=None, naming_convention=alembic_utils.naming_convention, recreate=alembic_utils.never_if_mysql()) as batch_op:
        batch_op.add_column(sa.Column('cluster_id', sa.Integer(), nullable=False))
        ...
        alembic_utils.drop_fk_by_shape('web_socket_sub', 'server_id', 'server', 'id')
        alembic_utils.drop_fk_by_shape('web_socket_sub', 'client_id', 'web_socket_client', 'id')
